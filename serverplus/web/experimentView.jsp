...
//                                                out.write("<tr><th>Mac Address</th><th>RSSI</th><th>BSSID</th><th>SSID</th><th>Log File Received</th><th>Control File</th><th>Control File Sent</th><th>Experiment Over</th><th>Status</th></tr>");
                                                ...
                                                while (rs.next()) {
                                                    out.write("<tr><td><a href=experimentDeviceInformation.jsp?macAddr=" + rs.getString(1) + "&expId=" + expid + ">" + rs.getString(1) + "</a></td><td>"+rs.getString(11)+"</td><td>" + rs.getString(3) + "</td><td>" + rs.getString(4) + "</td><td>" + rs.getString(5) + "</td><td>"
                                                            + (rs.getString(8).equals("1") ? "<a href=\"download.jsp?path=" + path1 + "&fileid=" + expid + "&name=" + rs.getString(1) + "\" >" + "Received" + "</a>" : "Not Received")
                                                            + ("</td><td><a href=\"download.jsp?path=" + path + "&fileid=" + rs.getString(11)+"/clients" + "&name=" + rs.getString(1)+"_"+rs.getString(11)+ "_confFile" + "\" >" + "download" + "</a>")
                                                            /*
